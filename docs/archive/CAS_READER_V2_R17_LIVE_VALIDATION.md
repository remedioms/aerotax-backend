...
**Stand:** 2026-05-26T11:25:15.687120
**Branch:** `main`
...
| V2  | AEROTAX_CAS_READER_V2=1       | 509.7s | True | False |
...
| KPI | V1 | V2 | Diff |
| --- | --- | --- | --- |
| z72_tage | None | 6 | None |
| z72_eur | None | 84.0 | None |
| z73_tage | None | 5 | None |
| z73_eur | None | 70.0 | None |
| z74_tage | None | 0 | None |
| z74_eur | None | 0.0 | None |
| z76_tage | None | 136 | None |
| z76_eur | None | 5793.0 | None |
| fahrtage | None | 44 | None |
| arbeitstage | None | 168 | None |
| reinigungstage | None | 148 | None |
| hotel_naechte | None | 124 | None |
...
- **2025-01-06** — BLR Heimkehr — X darf NICHT als Frei verloren gehen
  - legacy: {'klass': 'Issue', 'marker': 'X', 'routing': 'FRA', 'layover_ort': None, 'overnight': None, 'eur': None, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
...
- **2025-04-08** — Pattern A residual — target_iata-Risiko
  - legacy: {'klass': 'Z76', 'marker': '90064', 'routing': 'FRA', 'layover_ort': None, 'overnight': None, 'eur': 32.0, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
- **2025-10-05** — Pattern A residual — target_iata-Risiko
  - legacy: {'klass': 'Z76', 'marker': '18776', 'routing': 'FRA', 'layover_ort': None, 'overnight': None, 'eur': 32.0, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
