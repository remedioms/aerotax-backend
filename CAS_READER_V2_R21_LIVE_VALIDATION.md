...
**Stand:** 2026-05-26T22:07:53.316286
**Branch:** `main`
...
| V2  | AEROTAX_CAS_READER_V2=1       | 1180.0s | True | False |
...
| KPI | V1 | V2 | Diff |
| --- | --- | --- | --- |
| z72_tage | None | 10 | None |
| z72_eur | None | 140.0 | None |
| z73_tage | None | 9 | None |
| z73_eur | None | 126.0 | None |
| z74_tage | None | 1 | None |
| z74_eur | None | 28.0 | None |
| z76_tage | None | 118 | None |
| z76_eur | None | 5058.0 | None |
| fahrtage | None | 41 | None |
| arbeitstage | None | 130 | None |
| reinigungstage | None | 130 | None |
| hotel_naechte | None | 87 | None |
...
- **2025-01-06** — BLR Heimkehr — X darf NICHT als Frei verloren gehen
  - legacy: {'klass': 'Z76', 'marker': 'X', 'routing': 'BLR', 'layover_ort': None, 'overnight': None, 'eur': 28.0, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
...
- **2025-01-05** — BLR Mid-Tour — X innerhalb Layover
  - legacy: {'klass': 'Z76', 'marker': '755', 'routing': 'BLR', 'layover_ort': None, 'overnight': None, 'eur': 42.0, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
