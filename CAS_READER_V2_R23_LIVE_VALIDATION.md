...
**Stand:** 2026-05-27T06:35:04.532268
**Branch:** `main`
...
| V2  | AEROTAX_CAS_READER_V2=1       | 1083.1s | True | False |
...
| z76_eur | None | 5112.0 | None |
| fahrtage | None | 42 | None |
| arbeitstage | None | 128 | None |
| reinigungstage | None | 127 | None |
| hotel_naechte | None | 86 | None |
...
- **2025-01-06** — BLR Heimkehr — X darf NICHT als Frei verloren gehen
  - legacy: {'klass': 'ZeroDay', 'marker': 'X', 'routing': 'FRA', 'layover_ort': None, 'overnight': None, 'eur': None, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
...
- **2025-01-05** — BLR Mid-Tour — X innerhalb Layover
  - legacy: {'klass': 'Z76', 'marker': 'LH755', 'routing': 'BLR', 'layover_ort': None, 'overnight': None, 'eur': 28.0, 'reason_counted': None, 'why_suspicious': None}
  - normalized: None
